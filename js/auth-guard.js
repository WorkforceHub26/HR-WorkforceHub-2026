...
async function renderGlobalUserProfile() {
  ...
  document.querySelectorAll(".user-profile").forEach(container => {
    ...
    // รูปภาพ
    if (avatarUrl) {
      html += `<img src="${avatarUrl}" class="avatar" style="object-fit: cover;" onerror="this.onerror=null;this.src=\x22/assets/img/default-avatar.jpg\x22;">`;
    } else {
      let initials = "U";
    ...
    html += '<div class="info" style="display: flex; flex-direction: column; text-align: left; margin-left: 10px;">' +
